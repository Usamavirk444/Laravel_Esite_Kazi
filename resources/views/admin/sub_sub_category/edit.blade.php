        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="POST" id="addBrand" action="{{ route('subsubcategory.update') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="controls">
                                                ...
                                                <select name="category_id" class="form-control">
                                                    ...
                                                    @foreach ($category as $item)
                                                        <option value="{{ $item->id }}" {{$item->id == $subsubcategory->category_id? 'selected':''}}>{{ $item->category_name_eng }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{{$subsubcategory->subsubcategory_name_eng}}" name="subsubcategory_name_eng" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="" type="text" value="{{$subsubcategory->subsubcategory_name_urdu}}" name="subsubcategory_name_urdu"
                                                    class="form-control">

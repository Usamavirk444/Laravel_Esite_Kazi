                        ...
                        <div class="col">
                            <form method="POST" id="addBrand" enctype="multipart/form-data"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input id="current_password" type="text" name="nameEng"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="password" type="text" name="nameUrdu" class="form-control"
                                                    value="{{ $brand->brand_name_urdu }}">
                                                @error('nameUrdu')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <div class="help-block"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="password_confirmation" type="file" name="img"
                                                    class="form-control">
                                                @error('img')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                ...
                                <div class="text-xs-right">
                                    <button type="submit" class="btn btn-rounded btn-block btn-info">Update Brand</button>
                                </div>
                            </form>
